...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Correct Breed, happens when pet image is a dog and pet image and classifier label is a match
        ...
        if results_dic[key][3] == 1:
            ...
            # Classifier classifies image as not Dog (& pet image is not a dog)
